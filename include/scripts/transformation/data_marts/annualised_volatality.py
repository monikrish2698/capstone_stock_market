...
df_with_std = (
    ...
    .withColumn("annualised_7d_volatility", sqrt("variance_7d")*sqrt(252)) # multiply by sqrt(252) to get annualised volatility
    .withColumn("annualised_30d_volatility", sqrt("variance_30d")*sqrt(252)) # multiply by sqrt(252) to get annualised volatility
