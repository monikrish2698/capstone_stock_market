...
import boto3
import json
from include.aws.upload_to_s3 import upload_to_s3
...
def create_glue_job(
    ...
    **kwargs
    ...
    if include_to_s3:
        ...
        if not include_path:
            raise ValueError('Uploading include.zip to S3 failed!!')
    ...
    job_args = {
        ...
        'DefaultArguments': {
            ...
            "--extra-py-files": f"s3://{s3_bucket}/monk-glue-libs/include.zip"
        },
        'GlueVersion': '4.0',
        'WorkerType': 'Standard',
        'NumberOfWorkers': 1
